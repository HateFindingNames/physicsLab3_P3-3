...
%
    ...
    \subsection{Equations for the Sensor Capacitances}\label{sec:preparation_task_5}
        ...
        \begin{figure}[h]
            \centering
            \subfloat[Rotor at \( \varphi = \pm \frac{\pi}{2} \)\label{subfig:rotorAt pm halfPi}]{\includegraphics[width=.3\textwidth]{aufbau/statorRotorStator_pi.jpg}}
            \subfloat[Rotor at \( \varphi = 0 \)\label{subfig:rotorAt0}]{\includegraphics[width=.3\textwidth]{aufbau/statorRotorStator_0.5pi.jpg}}
            \subfloat[Rotor at \( \varphi = \mp \frac{\pi}{2} \)\label{subfig:rotorAt mp halfPi}]{\includegraphics[width=.3\textwidth]{aufbau/statorRotorStator_0.jpg}}
